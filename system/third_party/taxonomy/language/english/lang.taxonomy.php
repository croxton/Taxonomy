...
"advanced_settings_instructions" => 'Custom fields are optional, and will appear to publishers when editing nodes via the module interface.<br />By selecting "Display on publish?" the field will appear on the Taxonomy Fieldtype too.<br />To remove a row, leave the \'Field Name\' blank and save.',
